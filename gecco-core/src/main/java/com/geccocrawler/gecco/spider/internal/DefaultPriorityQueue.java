...
import static com.geccocrawler.gecco.spider.internal.PrioprityQueueNode.*;
...
public class DefaultPriorityQueue<T extends PrioprityQueueNode> extends AbstractQueue<T>
    ...
    public DefaultPriorityQueue(Comparator<T> comparator, int initialSize) {
        ...
        queue = (T[]) (initialSize != 0 ? new PrioprityQueueNode[initialSize] : EMPTY_ARRAY);
    }
    ...
    public boolean contains(Object o) {
        if (!(o instanceof PrioprityQueueNode)) {
            return false;
        }
        PrioprityQueueNode node = (PrioprityQueueNode) o;
